...
# ========= الإعدادات =========
BOT_TOKEN  = "8064352180:AAEK_mPLAl-S64EV1H7cWiNI2DmDr9pIZBk"  # التوكن الجديد متاع البوت
CHANNEL_ID = -1003487080023   # ID متاع ال Supergroup الجديد
...
def handle_start(message):
    ...
    # رابط الموقع متاع Render (صفحة /access)
    ...
    txt = (
        ...
        f"`{code}`\n\n"
        "✅ إدخل للموقع، حط الكود باش يتحقق من جهازك.\n\n"
        f"🌐 رابط الموقع:\n{site_url}"
    )
